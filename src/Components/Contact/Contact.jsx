...
const Contact = () => {
  return (
    <>
      <div className="px-10">
        <Form title={"Fill out this form"} firstField={"First Name"} secondField={"Last Name"} thirdField={"Email"} btnText={"Send"} />
        <div className="max-w-2xl mx-auto my-10">
          ...
          <p className="text-lg mb-5">
            ...
            touch with our team using the contact information below:
          </p>
          <div className="mb-5">
